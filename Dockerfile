...
RUN --mount=type=cache,id=s/f60e77a9-ba1d-433d-96d6-00d4ece01e29-openclaw-pnpm-store,target=/root/.local/share/pnpm/store,sharing=locked \
...
RUN --mount=type=cache,id=s/f60e77a9-ba1d-433d-96d6-00d4ece01e29-openclaw-bookworm-apt-cache,target=/var/cache/apt,sharing=locked \
    --mount=type=cache,id=s/f60e77a9-ba1d-433d-96d6-00d4ece01e29-openclaw-bookworm-apt-lists,target=/var/lib/apt,sharing=locked \
    apt-get update && \
